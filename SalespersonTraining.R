...
#Predict lnSales for those two points(average scores of both). The predicted values are 5.636512 for the score of 101 and 5.686739 for the mean score of trained employees
exp(5.686739)-exp(5.636512) 
# This is the impact of completing training on annual sales. On average, we can conclude that training increases annual sales per salesperson by about $14.4K.
 #================================================================
## END
#================================================================
